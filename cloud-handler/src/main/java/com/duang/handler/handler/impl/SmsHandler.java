...
import com.duang.cloudcommons.dto.model.SmsContentModel;
import com.duang.cloudcommons.enums.ChannelType;
import com.duang.handler.domain.sms.MessageTypeSmsConfig;
import com.duang.handler.domain.sms.SmsParam;
import com.duang.handler.handler.BaseHandler;
import com.duang.handler.handler.Handler;
import com.duang.handler.script.SmsScript;
import com.duang.support.support.domain.MessageTemplate;
import com.duang.support.support.domain.SmsRecord;
import com.duang.support.support.mapper.SmsRecordMapper;
        ...
        try {
            ...
            for (MessageTypeSmsConfig messageTypeSmsConfig : messageTypeSmsConfigs) {
                ...
                if (CollUtil.isNotEmpty(recordList)) {
                    recordList.forEach(r->smsRecordMapper.insert(r));
                    return true;
                }
            }
        } catch (Exception e) {
